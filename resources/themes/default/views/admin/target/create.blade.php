...
@section('content')
    ...
    <div class='row'>
        <div class='col-md-12 col-lg-12'>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{!! trans('admin/target/general.page.create.title') !!}</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div>
                <div class="box-body">
                    {!! Form::open( ['route' => 'admin.target.store', 'id' => 'form_create_target', 'class' => 'form-horizontal'] ) !!}
        ...
        <div class='col-md-12 col-lg-6'>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('admin/target/general.page.create.general-info') }}</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div>
                <div class="box-body">
    ...
    {!! JsValidator::formRequest('App\Http\Requests\CreateSalesTargetRequest', '#form_create_target') !!}
