        ...
        <div class='col-md-12'>
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{!! trans('branch_office/general.page.edit.section-title') !!}</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div>
                <div class="box-body">

                    {!! Form::model( $branchOffice, ['route' => ['admin.branchoffice.update', $branchOffice->id], 'method' => 'PATCH', 'id' => 'form_edit_branch_office', 'class' => 'form-horizontal'] ) !!}
