...
@section('content')
    ...
    <div class='row'>
        <div class='col-md-12 col-lg-12'>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{!! trans('admin/ovrcommission/general.page.create.title') !!}</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div>
                <div class="box-body">
                    {!! Form::open( ['route' => 'admin.ovrcommission.store', 'id' => 'form_create_ovrcommission', 'class' => 'form-horizontal'] ) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group select2-bootstrap-append">
                                {!! Form::select('agent_position_id', App\AgentPosition::getAgentPositions_ForDropDownCommission("ovr"), null, ['class' => 'form-control', 'style' => "width: 100%", 'tabindex' => 1]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group select2-bootstrap-append">
                                {!! Form::select('override_from', App\AgentPosition::getAgentPositions_ForDropDown("ovr"), null, ['class' => 'form-control', 'style' => "width: 100%", 'tabindex' => 1]) !!}
                                <span class="input-group-addon">
                                    <span class="fa fa-briefcase"></span>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('level', null, ['class' => 'form-control', 'tabindex' => 2]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('percentage', null, ['class' => 'form-control', 'tabindex' => 3]) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-10 col-sm-offset-2">
                            ...
                            <div class="pull-right">
                                <a id="cancelForm" title="{{ trans('general.button.cancel') }}" class='btn btn-danger' href="{!! route('admin.ovrcommission.index') !!}"><span class="fa fa-times"></span> {{ trans('general.button.cancel') }}</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class='col-md-12 col-lg-6'>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('admin/ovrcommission/general.page.create.general-info') }}</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div>
                <div class="box-body">
    ...
    {!! JsValidator::formRequest('App\Http\Requests\CreateOverridingCommissionRequest', '#form_create_ovrcommission') !!}
