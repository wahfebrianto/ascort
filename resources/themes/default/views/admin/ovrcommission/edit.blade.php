        ...
        <div class='col-md-12'>
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{!! trans('admin/ovrcommission/general.page.edit.section-title') !!}</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div>
                <div class="box-body">

                    {!! Form::model( $commission, ['route' => ['admin.ovrcommission.update', $commission->id], 'method' => 'PATCH', 'id' => 'form_edit_ovrcommission', 'class' => 'form-horizontal'] ) !!}
...
@section('body_bottom')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\EditOverridingCommissionRequest', '#form_edit_ovrcommission') !!}
@endsection
