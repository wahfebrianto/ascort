        ...
        <div class='col-md-12'>
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{!! trans('sales/general.page.edit.section-title') !!}</h3>
                    <div class="box-tools pull-right">
                    </div>
                </div>
                <div class="box-body">

                    {!! Form::model( $sale, ['route' => ['sales.update', $sale->id], 'method' => 'PATCH', 'id' => 'form_edit_sale', 'class' => 'form-horizontal'] ) !!}
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_basic">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group select2-bootstrap-append">
                                            {!! Form::select('agent_id', $agents, null, ['class' => 'form-control select2', 'style' => "width: 100%", 'tabindex' => 10]) !!}
                                            <span class="input-group-addon">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										{!! Form::text('m_nominal', $sale->nominal * 100, ['class' => 'form-control maskmoney', 'tabindex' => 13, 'id' => 'm_nominal']) !!}
...
@section('body_bottom')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\EditSaleRequest', '#form_edit_sale') !!}
@endsection
