        ...
        <div class='col-md-12'>
            <div class="box box-primary fa-bg fa-bg-export fa-bg-small">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('slips/recap/general.page.index.export-title') }}</h3>
                ...
                <div class="box-body" id="form-container">
                    ...
                    {!! Form::open( ['route' => 'slips.recap.export', 'id' => 'form_export_sales', 'method' => 'GET', 'class' => 'form-horizontal'] ) !!}
