<script language="JavaScript">
    ...
    $(document).ready(function() {
        ...
        $("#btnEnableSelected").on('click', function() {
            if(confirm('{!! trans('general.confirm.restore-selected') !!}')) {
                var $form = $('div#form-container > form');
                $form.attr('action', '{!! route($module_name . '.enable-selected') !!}');
                $form.submit();
            }
            return false;
        });
