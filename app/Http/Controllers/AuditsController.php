...
class AuditsController extends Controller {
    ...
    {
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/audit/general.audit-log.category'), trans('admin/audit/general.audit-log.msg-index'));
        ...
        $dataProvider = \App\Models\Audit::getIndexDataProvider();

        return view('admin.audit.index', compact('audits', 'dataProvider', 'purge_retention', 'page_title', 'page_description'));
    }

    public function purge()
    {
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/audit/general.audit-log.category'), trans('admin/audit/general.audit-log.msg-purge'));
...
//            $this->audit->delete($audit->id);
    ...
    {
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/audit/general.audit-log.category'), trans('admin/audit/general.audit-log.msg-replay', ['ID' => $id]));
    ...
    public function show($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/audit/general.audit-log.category'), trans('admin/audit/general.audit-log.msg-show'));
