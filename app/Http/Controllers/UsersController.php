...
class UsersController extends Controller {
    ...
    {
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-index'));
    ...
    public function show($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-show', ['username' => $user->username]));
...
//        $roleList = [''=>''] + $roleCollection->all();
    ...
    public function store(CreateUserRequest $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-store', ['username' => $attributes['username']]), $attributes);
    ...
    public function edit($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-edit', ['username' => $user->username]));
    ...
    public function replayEdit($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-replay-edit', ['username' => $user->username]));
    ...
    public function destroy($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-destroy', ['username' => $user->username]));
    ...
    public function enable($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-enable', ['username' => $user->username]));
    ...
    public function disable($id)
    {
        ...
        {
            Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-disabled', ['username' => $user->username]));
    ...
    public function enableSelected(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-enabled-selected'), $chkUsers);
    ...
    public function disableSelected(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/users/general.audit-log.category'), trans('admin/users/general.audit-log.msg-disabled-selected'), $chkUsers);
