...
//        //TODO: Warn of any routes in our DB that is not used in the app.
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-index'));
    ...
    public function show($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-show', ['name' => $route->name]));
    ...
    public function store(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-store', ['name' => $attributes['name']]));
    ...
    public function edit($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-edit', ['name' => $route->name]));
    ...
    public function update(Request $request, $id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-update', ['name' => $route->name]));
    ...
    public function destroy($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-destroy', ['name' => $route->name]));
    ...
    public function enable($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-enable', ['name' => $route->name]));
    ...
    public function disable($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-disabled', ['name' => $route->name]));
    ...
    {
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-load'));
    ...
    public function savePerms(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-save-perms'), $AuditAtt);
    ...
    public function enableSelected(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-enabled-selected'), $chkRoute);
    ...
    public function disableSelected(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/routes/general.audit-log.category'), trans('admin/routes/general.audit-log.msg-disabled-selected'), $chkRoute);
