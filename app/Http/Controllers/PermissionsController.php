...
class PermissionsController extends Controller {
    ...
    public function index()
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-index'));
    ...
    public function show($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-show', ['name' => $perm->name]));
    ...
    public function store(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-store', ['name' => $attributes['name']]));
    ...
    public function edit($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-edit', ['name' => $perm->name]));
    ...
    public function update(Request $request, $id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-update', ['name' => $perm->name]));
    ...
    public function destroy($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-destroy', ['name' => $permission->name]));
    ...
    {
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-generate'));
    ...
    public function enable($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-enable', ['name' => $permission->name]));
    ...
    public function disable($id)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-disabled', ['name' => $permission->name]));
    ...
    public function enableSelected(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-enabled-selected'), $chkPerms);
    ...
    public function disableSelected(Request $request)
    {
        ...
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/permissions/general.audit-log.category'), trans('admin/permissions/general.audit-log.msg-disabled-selected'), $chkPerms);
