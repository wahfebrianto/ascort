...
//    }
    ...
    {
        // Log action by user.
        Audit::log(Auth::user()->id, request()->ip(), trans('admin/menu-builder/menu-builder.audit-log.category'), trans('admin/menu-builder/menu-builder.audit-log.msg-index'));
    ...
    public function destroy($id)
    {
        ...
        {
            Audit::log(Auth::user()->id, request()->ip(), trans('admin/menu-builder/menu-builder.audit-log.category'), trans('admin/menu-builder/menu-builder.audit-log.msg-destroy', ['label' => $menu->label]));
